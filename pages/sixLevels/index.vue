	...
	export default {
		...
		methods: {
			toThisTest(pid, belongTo, yearPid) {
				/* uni.navigateTo({
					url: "/pages/testPart/index?" + "cetFourOrSix=" + this.cetFourOrSix + "&yearId=" + pid +
						"&belongTo=" +
						belongTo
				}) */
				this.isShow = true;
			...
			toSectionA() {
				...
				this.isShow = false;
				uni.navigateTo({
					url: "/pages/cetSixTestA/index?" + "cetFourOrSix=" + this.cetFourOrSix + "&yearId=" + this
			...
			toSectionB() {
				this.isShow = false;
				uni.navigateTo({
					url: "/pages/cetSixTestB/index?" + "cetFourOrSix=" + this.cetFourOrSix + "&yearId=" + this
						.yearId + "&belongTo=" + this.belongTo +
						"&section=" + 1
				})
			},
			toSectionC() {
				this.isShow = false;
				uni.navigateTo({
					url: "/pages/cetSixTestC/index?" + "cetFourOrSix=" + this.cetFourOrSix + "&yearId=" + this
						.yearId + "&belongTo=" + this.belongTo +
						"&section=" + 2
				})
			},
			toSectionAll() {
				this.isShow = false;
				uni.navigateTo({
					url: "/pages/cetSixTestAll/index?" + "cetFourOrSix=" + this.cetFourOrSix + "&yearId=" + this
						.yearId + "&belongTo=" + this.belongTo +
						"&section=" + 3
				})
			}
