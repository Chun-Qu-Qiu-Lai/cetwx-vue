	...
	<view style="padding-top: 10%;">
		...
		<view class="part">
			...
			<view class="part-subtitle">
				Directions: In this section, you will hear threenews reports. At the end of each news report, you
				will
				hear two or three questions. Both thenews report and the questions will be spokenonly once. After
				you
				hear a
				question, you mustchoose the best answer from the four choices marked A, B, C and D. Then mark
				thecorresponding letter on Answer Sheet 1 with a single line through the centre.
			</view>
		</view>
		<view class="questionsTitle">Questions 1 and 2
			are
			based on the news
		...
		<view class="part">
			...
			<view class="part-subtitle">
				Directions: In this section, you will hear two long conversations. At the end of eachconversation, you
				will hear four questions. Both the conversation and the questionswill be spoken only once. After you
				hear a question, you must choose the best answerfrom the four choices marked A, B, C and D. Then mark
				the corresponding letter onAnswer Sheet 1with a single line through the centre.
			</view>
		</view>
		<view class="questionsTitle">Questions 8 to 11 are
			...
			<uni-section type="line">
				<view class="uni-px-5">
					...
					<uni-data-checkbox :selectedColor="selectedColorP" selectedTextColor="#fff" mode="tag"
						...
						:localdata="optiones[13]" @change="changOption(13)" id="checkbox_13"
						:radioOption="radioOption13" :answer="optiones[13][0].answer" :disabled="isDisabled"
						:list_size="list_font_size">
					</uni-data-checkbox>
				</view>
			</uni-section>
		...
		<view class="part">
			...
			<view class="part-subtitle">
				...
				three or four questions. Both the passage and the questions will bespoken only once. After you hear a
				question, you must choose the best answer fromthe four choices marked A, B, C and D. Then mark the
				corresponding letter on AnswerSheet 1 with a single line through the centre.
			</view>
		</view>
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			if (this.cetFourOrSix == 4) {
				this.music = requestUrl.prod.cetListenFile + '/cetfile' + '/cetFourListen' + '/' + this.yearId + '/' + this
					.yearId +
					'-' +
