		...
		<template v-else>
			<checkbox-group v-if="multiple" class="checklist-group" :class="{'is-list':mode==='list' || wrap}"
				...
				<label class="checklist-box"
					...
					:style="{background:isSubmit?((radioOption==index)?selectedColor:'#fff') : ((answer==index)?(((radioOption==answer)?selectedColor:correctionColor)):(((radioOption==index)?selectedColor:'#fff'))) }"
					...
					<view class="checklist-content" :class="{'list-content':mode === 'list' && icon ==='left'}">
						<text class="checklist-text" :style="{fontSize: list_size}">{{item[map.text]}}</text>
